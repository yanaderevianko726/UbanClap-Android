...
class ProviderDocumentResource extends Controller
{
    ...
    public function index(Request $request, $provider)
    {
        try {
            ...
            return view('admin.providers.document.index', compact('Provider', 'ServiceTypes','ProviderService', 'ProviderAgent', 'backurl'));
    ...
    public function store(Request $request, $provider)
    {
        ...
        try {
            ...
            if($request->method == "update"){
                ...
                $ProviderAgent = ServiceType::where('id', $request->service_type)->where('agent_id', $Provider->agent)->first();
                if($ProviderAgent){

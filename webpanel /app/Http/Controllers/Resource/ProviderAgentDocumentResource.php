...
class ProviderAgentDocumentResource extends Controller
{
    /**
    ...
    public function index(Request $request, $provider)
    {
        try {
            ...
            $ServiceTypes = ServiceType::where('agent_id', $Provider->agent)->get();
            return view('agent.providers.document.index', compact('Provider', 'ServiceTypes','ProviderService','backurl'));
    ...
    public function store(Request $request, $provider)
    {
        ...
        return redirect()->route('agent.provider.document.index', $provider)->with('flash_success', trans('admin.provider_msgs.provider_service_update'));
    }
    ...
    public function edit($provider, $id)
    {
        try {
            ...
            return view('agent.providers.document.edit', compact('Document'));
        } catch (ModelNotFoundException $e) {
            return redirect()->route('agent.index');
        }
    }
    ...
    public function update(Request $request, $provider, $id)
    {
        try {
            ...
            return redirect()
                ->route('agent.provider.document.index', $provider)

...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	DB::table('permissions')->insert([
            ...
            ['name' => 'agent-list', 'display_name' => 'Agent Owner list', 'guard_name' => 'admin', 'group_name' => 'Agent Owner'],
            ['name' => 'agent-create', 'display_name' => 'Create Agent Owner', 'guard_name' => 'admin', 'group_name' => 'Agent Owner'],
            ['name' => 'agent-edit', 'display_name' => 'Edit Agent Owner', 'guard_name' => 'admin', 'group_name' => 'Agent Owner'],
            ['name' => 'agent-delete', 'display_name' => 'Delete Agent Owner', 'guard_name' => 'admin', 'group_name' => 'Agent Owner'],
            ['name' => 'agent-providers', 'display_name' => 'Agent Owner\'s Providers list', 'guard_name' => 'admin', 'group_name' => 'Agent Owner'],
        ...
        $agent->permissions()->attach( $permission );

	...
	'demo_mode_dialog' =>array(
		                  'admin'=>array(
						   ...
						   ",
							...
							"admin.agent.index" =>"<h3>Agent Panel</h3><li>Admin manages agent users.</li><li>
							Agent owner manage the details of a agent owner like name, email, image and company name</li><li>
							The list of providers under each agent can be viewed based on each company</li><li>
							Admin can add agent owners manually from admin panel</li><li>
							...
							<b>In the demo mode, You cannot  Add, Edit, Delete the agent user</b>
							",
							...
							"admin.agenttransfer" =>"<h3>Agent Settlements</h3><li>Admin should have a debit card to make a transaction with driver account</li>

...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form  action="{{route('admin.send.push')}}" method="POST" role="form" id="create_push">

                {{csrf_field()}}

                <div class="field">
                    <label class="label">@lang('admin.push.Sent_to')</label>
                    <div class="select control">
                        <select class="select" name="send_to" onchange="switch_send(this.value)">
                            <option value="ALL">All @lang('admin.user')s and @lang('admin.provider')s</option>
                            <option value="USERS">All @lang('admin.user')s</option>
                            <option value="PROVIDERS">All @lang('admin.provider')s</option>
                        </select>
                    </div>
                </div>

                <div class="field row" id="for_users" style="display: none;">
                    <label class="label">Conditions of @lang('admin.user')</label>
                    <div class="select col-xs-5">
                        <select class="select" name="user_condition" onchange="switch_user_condition(this.value);">
                            <option value="">None</option>
                            <option value="ACTIVE">FOR @lang('admin.user')s @lang('admin.active')s are ACTIVE </option>
                ...
                <div class="field row" id="for_providers" style="display: none;">
                    <label class="label">Conditions of @lang('admin.provider')s</label>
                    <div class="select col-xs-5">
                        <select class="select" name="provider_condition" onchange="switch_provider_condition(this.value);">
                            <option value="">None</option>
                            <option value="ACTIVE">FOR @lang('admin.provider')s @lang('admin.active')s are ACTIVE </option>
                            <option value="LOCATION">@lang('admin.provider')s who are in </option>
                            <option value="RIDES">Who used the service more than</option>
                ...
                <div class="field">
                    <label for="message" class="label">@lang('admin.push.message')</label>
                    <div class="control">
                ...
                <div class="field">
                    ...
                    <div class="control">							
                        <button type="submit" class="button is-link">@lang('admin.push.Push_Now')</button>
                        &nbsp;
                        <button data-toggle="modal" data-target="#schedule_modal" type="button" class="button is-success">@lang('admin.push.Schedule_Push')</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    ...
                    <label>Data</label>
                    <input value="{{date('m/d/Y')}}" class="input" type="text" id="datepicker" placeholder="Data" name="schedule_date">
                    <label>Hora</label>
                    <input value="{{date('H:i')}}" class="input" type="text" id="timepicker" placeholder="Hora" name="schedule_time">

                ...
                <div class="panel-body">
                    <form  role="form" method="POST" action="{{ url('/admin/register') }}">
                        ...
                        <div class="field{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="column control-label">Nome</label>
                        ...
                        <div class="field{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="column control-label">E-mail</label>
                        ...
                        <div class="field{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="password-confirm" class="column control-label">Confirmar Password</label>

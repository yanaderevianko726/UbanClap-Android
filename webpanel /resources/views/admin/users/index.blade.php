            ...
            <form action="{{ route('admin.user.index') }}" method="get">
                <div class="field columns" style="padding-left:0 !important; padding-right:0 !important; margin-bottom: 20px;">
                    <div class="column is-6">
                        <input name="name" type="text"  class="input" placeholder="Name of @lang('admin.user') or Email" aria-label="Name of @lang('admin.user')" aria-describedby="basic-addon2">
                    </div>
                    ...
                    @can('user-create')
                    <div class="column is-3">
                        <a href="{{ route('admin.user.create') }}" style="margin-left: 1em;" class="button is-link pull-right"><i class="fa fa-plus"></i> Add User</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.user.destroy', $user->id) }}" method="POST">
                                ...
                                @can('user-history')
                                <a href="{{ route('admin.user.request', $user->id) }}" class="button is-info"><i class="fa fa-search"></i> @lang('admin.History')</a>
                                @endcan
                                @if( Setting::get('demo_mode', 0) == 0)

                                @can('user-create')
                                <a href="{{ route('admin.user.edit', $user->id) }}" class="button is-info"><i class="fa fa-pencil"></i> @lang('admin.edit')</a>
                                @endcan

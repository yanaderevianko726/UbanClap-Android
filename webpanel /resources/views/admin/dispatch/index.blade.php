        ...
        <div class="dispatch-head">
            <nav class="navbar navbar-light bg-white b-a mb-2">
                ...
                <ul class="nav navbar-nav float-xs-right">
                    ...
                    <li class="nav-item">
                        <button type="button" class="button is-success btn-md label-right b-a-0 waves-effect waves-light"><span class="btn-label"><i class="ti-plus"></i></span>ADD
                        </button>
                    </li>
                    @endcan
                </ul>
                ...
                <div class="card">
                    ...
                    <div class="items-list">
                        ...
                        <div class="il-item">
                            ...
                            <a class="button  is-danger is-link mt-1" href="/admin/dispatcher/cancel?request_id=651">Cancel Ride</a>
                        </div>
                        <!-- Item Block Ends -->
                        <!-- Item Block Starts -->
                        <div class="il-item">

              ...
              <div class="container-fluid">
                  <div class="box tables-card">
                      <header class="box-header">
                          ...
                          <a href="{{ route('admin.dispatch-manager.create') }}" style="margin-left: 1em;" class="button is-link pull-right"><i class="fa fa-plus"></i> @lang('admin.dispatcher.add_new_dispatcher')</a>
                          @endcan
                          {{--  @can('account-manager-create')
                                  <a href="{{ route('admin.account-manager.create') }}" style="margin-left: 1em;" class="box-header-icon button is-link pull-right"><i class="fa fa-plus"></i> @lang('admin.account-manager.add_new_account_manager')</a>
                          @endcan  --}}
                      </header>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.dispatch-manager.destroy', $dispatcher->id) }}" method="POST">
                                ...
                                <a href="{{ route('admin.dispatch-manager.edit', $dispatcher->id) }}" class="button is-info"><i class="fa fa-pencil"></i> @lang('admin.edit')</a>

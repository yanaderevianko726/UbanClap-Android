...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="column" style="height:50px;color:red;">
            ...
            <a href="{{ route('admin.sub-admins.create') }}" style="margin-left: 1em;" class="button is-link pull-right"><i class="fa fa-plus"></i> Add Admin</a>
            @endcan
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.sub-admins.destroy', $user->id) }}" method="POST">
                                ...
                                @can('sub-admin-edit')
                                <a href="{{ route('admin.sub-admins.edit', $user->id) }}" class="button is-info"><i class="fa fa-pencil"></i> @lang('admin.edit')</a>
                                @endcan

...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form  action="{{route('admin.userdisputeupdate',$dispute->id)}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}

				<div class="field">
					<label for="user" class="label">@lang('admin.dispute.dispute_type')</label>
					<div class="col-xs-5">
						<input  class="input" type="text" value="{{ $dispute->dispute_type=="provider"?"@lang('admin.provider')":"@lang('admin.user')" }}" name="name" id="namesearch" disabled="">
				...
				<div class="field">
					...
					<div class="col-xs-5">
						<input  class="input" type="text" value="{{ $dispute->user->first_name }} {{ $dispute->user->last_name }}" name="name" id="namesearch" disabled="">
						<input type="hidden" name="request_id" id="request_id" value="">
					</div>
				</div>
				...
				<div class="field">
					...
					<div class="col-xs-5">
		                <table class="table is-striped is-bordered dataTable requestList">
		                    <thead>
		                        <tr>
		                            <th>ID da Viagem</th>
		                            <th>De </th>
				...
				<div class="field">
					...
					<div class="col-xs-5">
						<textarea class="input" name="dispute_other" placeholder="@lang('admin.dispute.dispute_name')" disabled="">{{ $dispute->dispute_name }}</textarea>
					</div>
				</div>

				<div class="field">
					<label for="lost_item_name" class="label">@lang('admin.dispute.dispute_comments')</label>
					<div class="col-xs-5">
						<textarea class="input" name="comments" placeholder="@lang('admin.dispute.dispute_comments')" required="">{{ $dispute->comments }}</textarea>
					</div>
				</div>

				<div class="field">
					<label for="lost_item_name" class="label">@lang('admin.dispute.dispute_refund') ({{config('constants.currency', '$')}})</label>
					<div class="col-xs-5">
						<input  class="input" type="text" value="{{ $dispute->refund_amount }}" name="refund_amount" id="refund_amount">
					</div>
				</div>

				<div class="field">
					<label for="status" class="label">@lang('admin.dispute.dispute_status')</label>
					<div class="col-xs-5">
					<input  class="input" type="text" readonly value="closed" name="status">
					</div>
				</div>

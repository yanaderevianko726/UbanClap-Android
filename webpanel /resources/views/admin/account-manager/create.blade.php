...
@section('title', __('admin.account-manager.add_account_manager'))
...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form  action="{{route('admin.account-manager.store')}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}
                <div class="field">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <button type="submit" class="button is-link">@lang('admin.account-manager.add_account_manager')</button>
                        <a href="{{route('admin.account-manager.index')}}" class="button is-default">@lang('admin.cancel')</a>
                    </div>
                </div>
            </form>
        </div>

...
@section('title', __('admin.account-manager.update_account_manager'))

@section('content')

        <div class="box is-block">

            <form  action="{{route('admin.account-manager.update', $account->id )}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}

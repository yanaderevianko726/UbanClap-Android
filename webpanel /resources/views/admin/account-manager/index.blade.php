...
@section('title', __('admin.account-manager.account_manager'))
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.account-manager.destroy', $account->id) }}" method="POST">
                                ...
                                <a href="{{ route('admin.account-manager.edit', $account->id) }}" class="button is-info"><i class="fa fa-pencil"></i> @lang('admin.edit')</a>

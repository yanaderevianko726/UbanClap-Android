...
<div class="column">
    <div class="dash-content container box ">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{url('confirm/ride')}}" method="GET" onkeypress="return disableEnterKey(event);">
					 <input type="text" class="input" id="origin-input" name="s_address"  placeholder="Enter pickup location" value="" disabled="">
					 <input type="text" class="input" id="destination-input" name="d_address"  placeholder="Enter drop location" >
				...
				<div class="modal-footer">
					<button type="button" class="button is-primary locchange">Submit</button>
				</div>
				</form>
			</div>
		</div>
			...
			render: function(){
				return (
					<form action="{{url('cancel/ride')}}" method="POST">
		            	...
		            	<button type="submit" className="button is-primary fare-btn">@lang('user.ride.cancel_request')</button> 
		            </form>
				);
			}
		});
			...
			render: function(){
				return (
					...
					<input type="hidden" name="request_id" value={this.props.checkState.id} />
			            ...
			            <CancelReason/>
		            	<button type="button" className="button is-primary" data-toggle="modal" data-target="#cancel-reason">@lang('user.ride.cancel_request')</button>
		            	<br/>
						...
						<div className="modal-dialog">
							<div className="modal-content">
								...
								<div className="modal-body">
									...
									<textarea className="form-control @if($request->reasons) cancel_hide @endif" id="cancel_text" name="cancel_reason_opt" placeholder="@lang('user.ride.cancel_reason')" columns="5"></textarea>
								</div>
			...
			render: function(){
				...
				<div>
					...
					<div className="status">
                    	...
                    	<button type="submit" className="button is-primary fare-btn">CONTINUE TO PAY - {this.props.currency}{this.state.payable.toFixed(fixval)}</button>   
                    </form>
		        </div>
				);
			}
		...
		var Review = React.createClass({
			render: function(){
				...
				{{ csrf_field() }}</input>
                    ...
                    <button type="submit" className="button is-primary fare-btn">SUBMIT</button>   
                </form>
				);
			}
		});

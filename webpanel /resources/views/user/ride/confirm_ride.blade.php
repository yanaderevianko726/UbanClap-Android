        ...
        <div class="columns no-margin">
            <div class="column">
                ...
                {{ csrf_field() }}
                    ...
                    <select class="select" name="promocode_id" id="promocode">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" id="schedule_button" class="button is-default" data-dismiss="modal">@lang('user.schedule_ride')</button>
      </div>

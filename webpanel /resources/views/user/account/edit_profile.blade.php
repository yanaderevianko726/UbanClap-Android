...
<div class="column is-9">
    <div class="dash-content">
        ...
        <div class="columns no-margin edit-pro">
            ...
            {{ csrf_field() }}
                ...
                <div class="field column">
                    ...
                    <input type="text" class="input" name="first_name" required placeholder="@lang('user.profile.first_name')" value="{{Auth::user()->first_name}}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="First Name can only contain alphanumeric characters and . - spaces">
                </div>
                <div class="field column">
                    <label>@lang('user.profile.last_name')</label>
                    <input type="text" class="input" name="last_name" required placeholder="@lang('user.profile.last_name')" value="{{Auth::user()->last_name}}" data-validation-allowing=" -" data-validation-error-msg="Last Name can only contain alphanumeric characters and . - spaces">
                </div>

                <div class="field column">
                    <label>@lang('user.profile.email')</label>
                    <input type="email" class="input" placeholder="@lang('user.profile.email')" readonly value="{{Auth::user()->email}}">
                </div>

                <div class="columns no-margin">
                    <div class="prof-sub-col col-sm-6 column">
                        <div class="field">
                            <label>@lang('user.profile.mobile')</label>
                            <input type="text" class="input" id="phone_number" required placeholder="Contact Number" name="mobile" value="{{ Auth::user()->mobile }}" data-validation="custom length" data-validation-length="10-15" data-validation-regexp="^([0-9\+]+)$" data-validation-error-msg="Incorrect phone number" disabled="disabled">
                    ...
                    <div class="prof-sub-col col-sm-6 column no-left-padding">
                        <div class="field">
                            <label>&nbsp;</label>
                            <a class="button is-block btn-primary update-link update-mobile" style="margin-top: 0;">@lang('user.profile.change_mobile')</a>
                            <a class="button is-block btn-primary update-link verify-mobile" style="margin-top: 0; display: none;">@lang('user.profile.verify')</a>
                        </div>
                    </div>
                </div>

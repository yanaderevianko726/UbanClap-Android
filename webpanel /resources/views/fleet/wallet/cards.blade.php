...
<div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="mb-1">Cartão de Debit</h5>
                <a href="#" style="margin-left: 1em;" class="button is-link pull-right" data-toggle="modal" data-target="#add-card-modal"><i class="fa fa-plus"></i> @lang('provider.card.add_debit_card')</a>

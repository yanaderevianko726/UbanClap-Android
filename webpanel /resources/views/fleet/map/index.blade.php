...
<script>
    ...
    function initMap() {
        ...
        div.innerHTML = '<img src="' + mapIcons['offline'] + '"> ' + '@lang('admin.provider') Indisponível';
        legend.appendChild(div);

        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['active'] + '"> ' + '@lang('admin.provider') Disponivel';
        legend.appendChild(div);

        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['hold'] + '"> ' + '@lang('admin.provider') em Descanso';
        legend.appendChild(div);

        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['unactivated'] + '"> ' + '@lang('admin.provider') @lang('admin.inactive')';
        legend.appendChild(div);

...
<!--            <div class="col-md-4">
            ...
            <div>
                <input id="service-number" type="hidden" class="form-control" name="service_number" value="123123" placehold="@lang('provider.profile.car_number')" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.car_number') can only contain alphanumeric characters and - spaces">
            ...
            <div>
                <input id="service-model" type="hidden" class="form-control" name="service_model" value="sample 1" placehold="@lang('provider.profile.car_model')" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.car_model') can only contain alphanumeric characters and - spaces">

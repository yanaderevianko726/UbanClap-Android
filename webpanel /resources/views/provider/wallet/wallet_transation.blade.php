                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="column">
                            ...
                            <div class="input-group full-input">
                                <input type="number" class="input" name="amount" placeholder="@lang('user.enter_amount')" >
                            </div>

                            
                            <button type="submit" id="submit-button" class="button is-primary fare-btn">@lang('user.add_money')</button> 

            ...
            <div class="row no-margin">
                <div className="column">  
                    <form method="POST" action="provider/profile/available">
                        ...
                        <a href="{{ route('provider.documents.index') }}" class="button is-primary">@lang('provider.document_upload')</a>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="row no-margin">
                <div className="column">  
                    <form method="POST" action="provider/profile/available">
                        ...
                        <a href="{{ route('provider.cards') }}" class="button is-primary">@lang('provider.card.add_debit_card')</a>
                    </form>
                </div>
            </div>
        </div>

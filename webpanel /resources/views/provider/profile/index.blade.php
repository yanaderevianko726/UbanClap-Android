                        ...
                        <form class="profile-form" action="{{route('provider.profile.update')}}" method="POST" enctype="multipart/form-data" role="form">
                                ...
                                <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 column no-left-padding">
                                        <div class="field">
                                            ...
                                            <input type="text" class="input" placeholder="@lang('provider.profile.first_name')" name="first_name" value="{{ Auth::guard('provider')->user()->first_name }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.first_name') @lang('provider.profile.error_msg')">
                                        </div>
                                    </div>
                                    <div class="prof-sub-col col-sm-6 column no-right-padding">
                                        <div class="field">
                                            <label>@lang('provider.profile.last_name')</label>
                                            <input type="text" class="input" placeholder="@lang('provider.profile.last_name')" name="last_name" value="{{ Auth::guard('provider')->user()->last_name }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.last_name') @lang('provider.profile.error_msg')">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 column no-left-padding">
                                        <div class="field">
                                            ...
                                            <input type="text" class="input" id="phone_number" required placeholder="Contact Number" name="mobile" value="{{ Auth::guard('provider')->user()->mobile }}" data-validation="custom length" data-validation-length="10-15" data-validation-regexp="^([0-9\+]+)$" data-validation-error-msg="@lang('provider.profile.error_phone')" disabled="disabled">
                                    ...
                                    <div class="prof-sub-col col-sm-6 column no-left-padding">
                                        <div class="field">
                                            <label>&nbsp;</label>
                                            <a class="button is-block btn-primary update-link update-mobile" style="margin-top: 0;">@lang('provider.profile.change_mobile')</a>
                                            <a class="button is-block btn-primary update-link verify-mobile" style="margin-top: 0; display: none;">@lang('provider.profile.verify')</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="prof-form-sub-sec border-top">
                                <div class="field">
                                    ...
                                    <input type="text" class="input" placeholder="@lang('provider.profile.address')" name="address" value="{{ Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->address : "" }}">
                                    <input type="text" class="input" placeholder="@lang('provider.profile.full_address')" style="border-top: none;" name="address_secondary" value="{{ Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->address_secondary : "" }}">
                                </div>
                                ...
                                <!-- <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 column no-left-padding">
                                        <div class="field no-margin">
                                            ...
                                            <input type="text" class="input" placeholder="@lang('provider.profile.city')" name="city" value="{{ Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->city : "" }}">
                                        </div>
                                    </div>
                                    <div class="prof-sub-col col-sm-6 column no-right-padding">
                                        <div class="field">
                                ...
                                <div class="row no-margin">
                                    <!-- <div class="prof-sub-col col-sm-6 column no-left-padding">
                                        <div class="field no-margin">
                                            ...
                                            <input type="text" class="input" placeholder="@lang('provider.profile.pin')" name="postal_code" value="{{ Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->postal_code : "" }}">
                                        </div>
                                    </div> -->
                                    <div class="prof-sub-col col-sm-6 column no-left-padding">
                                        <div class="field">
                                ...
                                <div class="row no-margin">                                    
                                    <div class="prof-sub-col col-sm-6 column no-left-padding">
                                        <div class="field">
                                            ...
                                            <input type="text"  placeholder="@lang('provider.profile.car_model')" class="input" name="service_model" value="{{ Auth::guard('provider')->user()->service->service_model ? Auth::guard('provider')->user()->service->service_model : "" }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('provider.profile.car_model') @lang('provider.profile.error_msg')">
                                        </div>
                                    </div>
                                </div>
                            </div>

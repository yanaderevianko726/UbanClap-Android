...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="col-md-12" style="height:50px;color:red;">
            ...
            <a href="<?php echo e(route('admin.role.create')); ?>" style="margin-left: 1em;" class="button is-link pull-right"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('admin.roles.add_role'); ?></a>
            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin/resources/views/admin/roles/index.blade.php ENDPATH**/ ?>
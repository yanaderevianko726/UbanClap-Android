        ...
        <div class="box box-block bg-white">
            <div class="clearfix mb-1">
                ...
                <div class="float-xs-right">
                    <button class="button is-link godseye_menu" data-value="ALL">All</button>
                    <button class="button is-default godseye_menu" data-value="ACTIVE">Disponíveis</button>
                    <button class="button is-default godseye_menu" data-value="STARTED">A Caminho do Embarque</button>
                    <button class="button is-default godseye_menu" data-value="ARRIVED">No Local de Embarque</button>
                    <button class="button is-default godseye_menu" data-value="PICKEDUP">Em Viagem</button>
                </div>
            </div>
            <div class="columns">
                <div class="column">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin 2/resources/views/admin/godseye.blade.php ENDPATH**/ ?>
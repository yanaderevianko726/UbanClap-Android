    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form action="<?php echo e(route('admin.password.update')); ?>" method="POST" role="form">
                ...
                <div class="field">
                    <label for="old_password" class="column label"><?php echo app('translator')->getFromJson('admin.account.old_password'); ?></label>
                    <div class="control">
                ...
                <div class="field">
                    <label for="password" class="column label"><?php echo app('translator')->getFromJson('admin.account.password'); ?></label>
                    <div class="control">
                ...
                <div class="field">
                    <label for="password_confirmation" class="column label"><?php echo app('translator')->getFromJson('admin.account.password_confirmation'); ?></label>
                    <div class="control">
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin 2/resources/views/admin/account/change-password.blade.php ENDPATH**/ ?>
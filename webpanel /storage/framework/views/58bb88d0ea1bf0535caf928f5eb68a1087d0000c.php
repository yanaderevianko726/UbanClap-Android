                                            ...
                                            <div class="fare-break">
                                               ...
                                               <form method="POST" action="<?php echo e(url('cancel/ride')); ?>">
                                                  <?php echo e(csrf_field()); ?>
                                                   ...
                                                   <button class="full-primary-btn fare-btn" type="submit"><?php echo app('translator')->getFromJson('user.ride_cancel'); ?></button>
                                               </form>
...
<?php echo $__env->make('user.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin/resources/views/user/ride/upcoming.blade.php ENDPATH**/ ?>
...
<script>
    ...
    function initMap() {
        ...
        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['offline'] + '"> ' + '<?php echo app('translator')->getFromJson('admin.provider'); ?> em Descanso';
        legend.appendChild(div);
        
        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['active'] + '"> ' + '<?php echo app('translator')->getFromJson('admin.provider'); ?> Disponível';
        legend.appendChild(div);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin 2/resources/views/admin/map/index.blade.php ENDPATH**/ ?>
                ...
                success: function(data) {
                    ...
                    if(data.sendBtn == "yes") 
                    {
                        ...
                        .append(` <div class="row dis">
                            ...
                            <div class="col-xs-7">
                            <select <div class="control"> id="disputeReason">
                            </select> 
                             </div>
                             </div>
                             <div class="row dis">
...
<?php echo $__env->make('user.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin/resources/views/user/ride/trips.blade.php ENDPATH**/ ?>
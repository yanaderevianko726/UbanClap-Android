    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form action="<?php echo e(route('admin.user.index')); ?>" method="get">
                <div class="field row col-md-12" style="padding-left:0 !important; padding-right:0 !important; margin-bottom: 20px;">
                    <div class="col-xs-6">
                        <input name="name" type="text"  class="control" placeholder="Nome do Passageiro ou Email" aria-label="Nome do Passageiro" aria-describedby="basic-addon2">
                    </div>
                    ...
                    <div class="col-xs-3">
                        <a href="<?php echo e(route('admin.user.create')); ?>" style="margin-left: 1em;" class="button is-link pull-right"><i class="fa fa-plus"></i> Adicionar Novo</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(route('admin.user.destroy', $user->id)); ?>" method="POST">
                                ...
                                <button class="button  is-danger is-link" onclick="return confirm('Você tem certeza?')"><i class="fa fa-trash"></i> <?php echo app('translator')->getFromJson('admin.delete'); ?></button>
                                <?php endif; ?>
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin/resources/views/admin/users/index.blade.php ENDPATH**/ ?>
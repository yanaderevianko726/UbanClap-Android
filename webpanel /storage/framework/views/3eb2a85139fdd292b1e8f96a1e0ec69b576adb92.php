    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form action="<?php echo e(route('admin.profile.update')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="field">
                    <label class="label"><?php echo app('translator')->getFromJson('user.profile.language'); ?></label>
                    <div class="control">
                        <div class="select">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin/resources/views/admin/account/profile.blade.php ENDPATH**/ ?>
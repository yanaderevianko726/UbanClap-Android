                ...
                <div class="pay-option">
                    <h6>
                        ...
                        <form action="<?php echo e(url('card/destory')); ?>" method="POST" class="pull-right">
                            ...
                            <button onclick='return confirm("<?php echo app('translator')->getFromJson('user.card.delete_msg'); ?>")' type="submit" class="button is-sm" ><?php echo app('translator')->getFromJson('user.card.delete'); ?></button>
                        </form>
                    </h6>
                </div>
          ...
          <div class="modal-body">
            <div class="row no-margin" id="card-payment">
                <div class="field column col-sm-12">
                    ...
                    <input data-stripe="name" autocomplete="off" required type="text" class="input" placeholder="<?php echo app('translator')->getFromJson('user.card.fullname'); ?>">
                </div>
                <div class="field column col-sm-12">
                    <label><?php echo app('translator')->getFromJson('user.card.card_no'); ?></label>
                    <input data-stripe="number" type="text" onkeypress="return isNumberKey(event);" required autocomplete="off" maxlength="16" class="input" placeholder="<?php echo app('translator')->getFromJson('user.card.card_no'); ?>">
                </div>
                <div class="field column col-sm-12">
                ...
                <div class="field column col-sm-12">
                    ...
                    <input type="text" data-stripe="cvc" onkeypress="return isNumberKey(event);" required autocomplete="off" maxlength="4" class="input" placeholder="<?php echo app('translator')->getFromJson('user.card.cvv'); ?>">
                </div>
            </div>
          </div>

          <div class="modal-footer">
            <button type="submit" class="button is-default"><?php echo app('translator')->getFromJson('user.card.add_card'); ?></button>
          </div>
        </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin 2/resources/views/user/account/payment.blade.php ENDPATH**/ ?>
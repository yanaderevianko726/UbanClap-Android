<?php $__env->startSection('title', __('admin.dispute-manager.add_dispute_manager')); ?>
...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form  action="<?php echo e(route('admin.dispute-manager.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input  class="input" type="password" name="password_confirmation" id="password_confirmation" placeholder="<?php echo app('translator')->getFromJson('admin.dispute-manager.password_confirmation'); ?>">
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <button type="submit" class="button is-link"><?php echo app('translator')->getFromJson('admin.dispute-manager.add_dispute_manager'); ?></button>
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin/resources/views/admin/dispute-manager/create.blade.php ENDPATH**/ ?>
...
<div class="card events-card">
  ...
  <div class="card">
    <div class="container">
          ...
          <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('service-children',$services)->dom;
} elseif ($_instance->childHasBeenRendered('Fw1JoLx')) {
    $componentId = $_instance->getRenderedChildComponentId('Fw1JoLx');
    $componentTag = $_instance->getRenderedChildComponentTagName('Fw1JoLx');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Fw1JoLx');
} else {
    $response = \Livewire\Livewire::mount('service-children',$services);
    $dom = $response->dom;
    $_instance->logRenderedChild('Fw1JoLx', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin 2/resources/views/user/dashboard.blade.php ENDPATH**/ ?>
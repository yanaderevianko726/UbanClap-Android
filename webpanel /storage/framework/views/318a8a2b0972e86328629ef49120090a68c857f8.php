            ...
            <div class="row no-margin">
                <div className="column">  
                    <form method="POST" action="provider/profile/available">
                        ...
                        <a href="<?php echo e(route('provider.documents.index')); ?>" class="button is-primary"><?php echo app('translator')->getFromJson('provider.document_upload'); ?></a>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="row no-margin">
                <div className="column">  
                    <form method="POST" action="provider/profile/available">
                        ...
                        <a href="<?php echo e(route('provider.cards')); ?>" class="button is-primary"><?php echo app('translator')->getFromJson('provider.card.add_debit_card'); ?></a>
                    </form>
                </div>
            </div>
        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(Config::get('constants.map_key')); ?>&libraries=places&language=<?php echo app('translator')->getFromJson('provider.lang'); ?>" defer></script>
<script type="text/javascript">
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('provider.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin 2/resources/views/provider/index.blade.php ENDPATH**/ ?>
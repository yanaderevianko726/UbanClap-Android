    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <a href="<?php echo e(route('admin.peakhour.create')); ?>" style="margin-left: 1em;" class="button is-link pull-right"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('admin.peakhour.add_time'); ?></a>
                <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?php echo e(route('admin.peakhour.destroy', $peak->id)); ?>" method="POST">
                                    ...
                                    <a href="<?php echo e(route('admin.peakhour.edit', $peak->id)); ?>" class="button is-info"><i class="fa fa-pencil"></i> <?php echo e(__('admin.edit')); ?></a>
                                    <?php endif; ?>

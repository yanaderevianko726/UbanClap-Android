<?php $__env->startSection('title', __('admin.account-manager.account_manager')); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(route('admin.account-manager.destroy', $account->id)); ?>" method="POST">
                                ...
                                <a href="<?php echo e(route('admin.account-manager.edit', $account->id)); ?>" class="button is-info"><i class="fa fa-pencil"></i> <?php echo app('translator')->getFromJson('admin.edit'); ?></a>
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Documents/code/2020/thinkinservice2020/serviceadmin 2/resources/views/admin/account-manager/index.blade.php ENDPATH**/ ?>
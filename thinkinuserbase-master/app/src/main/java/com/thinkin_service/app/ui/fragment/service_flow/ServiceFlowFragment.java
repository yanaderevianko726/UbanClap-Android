package com.thinkin_service.app.ui.fragment.service_flow;
...
import com.thinkin_service.app.common.CancelRequestInterface;
...
import com.thinkin_service.app.data.network.model.ProviderService;
...
import com.thinkin_service.app.ui.fragment.cancel_ride.CancelRideDialogFragment;
...
import static com.thinkin_service.app.MvpApplication.showOTP;
...
public class ServiceFlowFragment extends BaseFragment
    ...
    private void initView(Datum datum) {
        ...
        if (providerService != null) {
            ...
            serviceNumber.setVisibility(View.GONE);
            serviceModel.setText(providerService.getServiceModel());
            serviceModel.setVisibility(View.GONE);
        }

package com.thinkin_service.app.data.network;
...
import com.thinkin_service.app.data.network.model.Coupon;
...
import com.thinkin_service.app.data.network.model.Rental;
...
public interface ApiInterface {
    ...
    Observable<CatageoriesMain> fetchCategories();

    @GET("api/user/banner")
    Observable<List<BannerResponse>> fetchBanners();
